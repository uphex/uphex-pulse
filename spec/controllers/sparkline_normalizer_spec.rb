...
describe 'SparklineNormalizer' do
  describe 'single day' do
    it 'should work for some data points in a day', :broken => true do
      expect(SparklineNormalizer.new([
                                                 {
                                             ...
                                             ]).normalized).to match_array(
      [{:index=>DateTime.new(2014,5,4,0,0).to_date,:value=>118.125}]
      )
    end
      ...
      expect(SparklineNormalizer.new([
                                                   ...
                                                   },
                                                   {
                                                       ...
                                                       :value=>60
                                                          ...
                                                          [{:index=>DateTime.new(2014,5,4,0,0).to_date,:value=>118.75}]
                                                      )
    end
    ...
    it 'should return an empty array if called with an empty array' do
      expect(SparklineNormalizer.new([]).normalized).to match_array([])
    end
  end
end
